...
fn main() {
    ...
    let artists = vec![
        Artist {name: "Metallica", genre: Genre("Heavy Metal"), origin: Location("U.S."), years_active: PeriodInYears(1981, None) }, 
        Artist {name: "Led Zeppelin", genre: Genre("Hard Rock"), origin: Location("England"), years_active: PeriodInYears(1968, Some(1980)) },
        Artist {name: "Bee Gees", genre: Genre("Pop"), origin: Location("England"), years_active: PeriodInYears(1958, Some(2003)) },
    ];
